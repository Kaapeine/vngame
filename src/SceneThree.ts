...
export class SceneThree extends Container implements IScene {
  ...
  public addStars(): void {
    ...
    //     const tex: Texture = Texture.from(starSeq[i]);
    //     starTexSeq.push(tex);
    // }
    ...
    const glowAnim: AnimatedSprite = AnimatedSprite.fromImages([
  ...
  public clickedScene(): void {
    ...
    Manager.fadeTransition(() => {
      ...
      const flame: AnimatedSprite = AnimatedSprite.fromImages([
